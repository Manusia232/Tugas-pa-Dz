<?php
session_start(); // Mulai session untuk menyimpan data keranjang

// Data barang (id, nama, harga, gambar)
$barang = [
    ['id' => 1, 'nama' => 'Kopi', 'harga' => 15000, 'gambar' => 'kopi.jpg'],
    ['id' => 2, 'nama' => 'Teh', 'harga' => 10000, 'gambar' => 'teh.jpg'],
    ['id' => 3, 'nama' => 'Roti', 'harga' => 12000, 'gambar' => 'roti.jpg'],
    ['id' => 4, 'nama' => 'Air Mineral', 'harga' => 5000, 'gambar' => 'air-mineral.jpg'],
    ['id' => 5, 'nama' => 'Es Krim', 'harga' => 20000, 'gambar' => 'eskrim.jpg'],
];
